...
export const ActivitiesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createActivity(name: string, type: string, startDateLocal: Date, elapsedTime: number, description: string, distance: number, trainer: number, commute: number, options: any = {}): FetchArgs {
...
export const ActivitiesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createActivity(name: string, type: string, startDateLocal: Date, elapsedTime: number, description: string, distance: number, trainer: number, commute: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DetailedActivity> {
            const localVarFetchArgs = ActivitiesApiFetchParamCreator(configuration).createActivity(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, options);
...
export const ActivitiesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createActivity(name: string, type: string, startDateLocal: Date, elapsedTime: number, description: string, distance: number, trainer: number, commute: number, options?: any) {
            return ActivitiesApiFp(configuration).createActivity(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, options)(fetch, basePath);
        },
        /**
         * Returns the given activity that is owned by the authenticated athlete. Requires activity:read for Everyone and Followers activities. Requires activity:read_all for Only Me activities.
         * @summary Get Activity
...
export class ActivitiesApi extends BaseAPI {
     ...
     */
    public createActivity(name: string, type: string, startDateLocal: Date, elapsedTime: number, description: string, distance: number, trainer: number, commute: number, options?: any) {
        return ActivitiesApiFp(this.configuration).createActivity(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, options)(this.fetch, this.basePath);
    }
